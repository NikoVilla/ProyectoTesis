...
# (str) Package name
package.name = proyectotesis

# (str) Package domain (needed for android/ios packaging)
package.domain = org.proyecto.tesis
...
source.include_patterns = Fuentes/*, Iconos/*, Logos/*
...
android.permissions = android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18), BLUETOOTH, BLUETOOTH_ADMIN, BLUETOOTH_CONNECT, BLUETOOTH_SCAN, NEARBY_DEVICES

#Opcion2
#android.permissions = INTERNET, WRITE_EXTERNAL_STORAGE, BLUETOOTH, BLUETOOTH_ADMIN, BLUETOOTH_CONNECT, BLUETOOTH_SCAN, NEARBY_DEVICES
